# # function consolidatedLoss!(params::Vector{Float64},a; returnforPlotting::Bool=false)::Any
# #     global additionals
# #     n = additionals[1]
# #     # n=7
# #     n̅ = additionals[2]
...
# # using NLSolvers, ThreadsX, Base.Threads

# # function csl_batched!(F,X, A)
# #     ThreadsX.map!(consolidatedLoss!, F, X, A)
# #     return F
# # end

# # obj = ScalarObjective(consolidatedLoss!, nothing, nothing, nothing, nothing, nothing, csl_batched!, nothing)

# # prob = OptimizationProblem(obj, pd, [1])

# # solve(prob, x0, ParticleSwarm(n_particles = 100,lower = 0*ones(length(paramz)), upper =[]), OptimizationOptions(maxiter=20))
...
# function objective1(params::Vector{Float64}, additionals::Vector{Int64})
#     n̅ = additionals[1]
#     # n=7
#     n̅ = additionals[2]
#     dt = 1e-4
...
# function objective2(params::Vector{Float64}, additionals::Vector{Int64})
#     n̅ = additionals[1]
#     # n=7
#     n̅ = additionals[2]
#     dt = 1e-4
...
#     return inactivationErr
# end

# function objective3(params::Vector{Float64}, additionals::Vector{Int64})
#     n̅ = additionals[1]
#     # n=7
#     n̅ = additionals[2]
#     dt = 1e-4
...
# function objective4(params::Vector{Float64}, additionals::Vector{Int64})
#     n̅ = additionals[1]
#     # n=7
#     n̅ = additionals[2]
#     dt = 1e-4
...
#     return recoveryUDBErr
# end

# function objective5(params::Vector{Float64}, additionals::Vector{Int64})
#     n̅ = additionals[1]
#     # n=7
#     n̅ = additionals[2]
#     dt = 1e-4
...
# function objective6(params::Vector{Float64}, additionals::Vector{Int64})
#     n̅ = additionals[1]
#     # n=7
#     n̅ = additionals[2]
#     dt = 1e-4
...
# function objective7(params::Vector{Float64}, additionals::Vector{Int64})
#     n̅ = additionals[1]
#     # n=7
#     n̅ = additionals[2]
#     dt = 1e-4
...
# function objec(p::Vector{Float64}, a::Vector{Int64})
#     return [objective1(p,a), objective2(p,a), objective3(p,a), objective4(p,a), objective5(p,a), objective6(p,a), objective7(p,a)], [0.0], [0.0]
# end
...
# bounds = [zeros(length(pd)) 100*ones(length(pd))];
# zeros(length(pd)) 100*ones(length(pd));
# zeros(length(pd)) 100*ones(length(pd));
# zeros(length(pd)) 100*ones(length(pd));
# zeros(length(pd)) 100*ones(length(pd));
# zeros(length(pd)) 100*ones(length(pd));
...
# # optimize
# status_moead = optimize(objec, bounds, moead_de)
